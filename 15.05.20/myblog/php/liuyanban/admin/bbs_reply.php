...
<form id="form1" name="form1" method="post" action="" onsubmit="return CheckForm()">
  <table width="30%" border="0" align="center" cellpadding="5" cellspacing="0" bordercolor="#00000">
    <tr>
      <th colspan="2" ><span class="white">管理员回复</span></th>
    </tr>
    <tr>
      <td colspan="2"  class="forumRowHighlight"><?php echo $rows["leave_contents"]?></td>
    </tr>
    <tr>
      <td  class="forumRowHighlight">回复内容:</td>
    ...
    <tr>
      <td colspan="2" align="left"  class="forumRowHighlight"><label>
        <textarea name="content" cols="50" rows="5">暂无回复内容</textarea>
      </label></td>
    </tr>
    <tr>
  ...
  <?php
		...
		?>
			...
			?>
		<form id="form1" name="form1" method="post" action="" onSubmit="return CheckForm()">
  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" bordercolor="#000000" >
    <tr>
      <th colspan="2" >管理员回复</th>
    </tr>
    
	<tr>
		<td colspan="2"  class="forumRowHighlight">			  </td>
	</tr>
    <tr>
