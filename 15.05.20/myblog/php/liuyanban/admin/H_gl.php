...
<table width="100%" border="0" cellpadding="5" cellspacing="0" class="table">
  <tr>
    ...
    <td class="bg_tr"><a href="ly_pwd.php" target="_new" class="bg_tr">修改密码</a></td>
	<td class="bg_tr"><a href="login.php?tj=out" target="_self" >退出登录</a></td>
    <td class="bg_tr"><a href="../index.php?tj=out" >返回留言板</a></td>
  </tr>
</table>
<?php
	...
	$rs=mysql_query($sql);
?>
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="td_bgf">
<?php
